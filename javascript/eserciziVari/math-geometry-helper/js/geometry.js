function calcolaQuadrato() {
    ...
    document.getElementById("risultatoAreaQuadrato").innerHTML = `Area: <br> ${area.toFixed(2)} cm<sup>2</sup>`;
    document.getElementById("risultatoPerimetroQuadrato").innerHTML = `Perimetro: <br> ${perimetro.toFixed(2)} cm`;
}
...
function calcolaRettangolo() {
    ...
    //Mando in output i risultati
    document.getElementById("risultatoAreaRettangolo").innerHTML = `Area: <br> ${area.toFixed(2)} cm<sup>2</sup>`;
    document.getElementById("risultatoPerimetroRettangolo").innerHTML = `Perimetro: <br> ${perimetro.toFixed(2)} cm`;
}
...
function calcolaTriangolo() {
    ...
    //Mando in output i risultati
    document.getElementById("risultatoAreaTriangolo").innerHTML = `Area: <br> ${area.toFixed(2)} cm<sup>2</sup>`;
    document.getElementById("risultatoPerimetroTriangolo").innerHTML = `Perimetro: <br> ${perimetro.toFixed(2)} cm`;
}
...
function calcolaCerchio() {
    ...
    //Mando in output i risultati
    document.getElementById("risultatoAreaCerchio").innerHTML = `Area: <br> ${area.toFixed(2)} cm<sup>2</sup>`;
    document.getElementById("risultatoCirconferenzaCerchio").innerHTML = `Circonferenza: <br> ${circonferenza.toFixed(2)} cm`;
}
...
function calcolaTrapezio() {
    ...
    //Mando in output i risultati
    document.getElementById("risultatoAreaTrapezio").innerHTML = `Area: <br> ${area.toFixed(2)} cm<sup>2</sup>`;
    document.getElementById("risultatoPerimetroTrapezio").innerHTML = `Perimetro: <br> ${perimetro.toFixed(2)} cm`;
}
...
function calcolaEllisse() {
    ...
    //Mando in output i risultati
    document.getElementById("risultatoAreaEllisse").innerHTML = `Area: <br> ${area.toFixed(2)} cm<sup>2</sup>`;
    document.getElementById("risultatoPerimetroEllisse").innerHTML = `Perimetro: <br> ${perimetro.toFixed(2)} cm`;
}
